...
@XmlType ( name = "ResourceExtension",
        propOrder = { "publisher", "name", "version", "label", "description", "publicConfigurationSchema",
                "privateConfigurationSchema", "sampleConfig", "replicationCompleted", "eula", "privacyUri",
                "homepageUri", "isJsonExtension", "isInternalExtension", "disallowMajorVersionUpgrade", "companyName",
