...
public class Deployment
{
    ...
    public Deployment( Builder builder )
    {
        ...
        if ( builder.roleName != null ) role.setRoleName( builder.roleName );
        else if ( builder.hostname != null ) role.setRoleName( builder.hostname );
        else role.setRoleName( builder.name + "-" + UUID.randomUUID().toString() );
    ...
    private List<ResourceExtensionReference> setupCustomScriptExtension( String accountJson, String scriptJson )
    {
        ...
        reference.getResourceExtensionParameterValues()
                .setResourceExtensionParameterValues( setupParameterValuesForCustomScript( accountJson, scriptJson ) );
            ...
            String scriptJson )
    {
        ...
        try
        {
            ...
            if ( scriptJson != null ) pvalues.add( setupParameterValue( "CustomScriptExtensionPublicConfigParameter",
                    Base64.encode( scriptJson.getBytes( "UTF-8" ) ), "Public" ) );
            if ( accountJson != null ) pvalues.add( setupParameterValue( "CustomScriptExtensionPrivateConfigParameter",
    ...
    {
        return "Name: " + name + " DeploymentSlot: " + deploymentSlot + " label: " + label + " Url: " + url + " "
